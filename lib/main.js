...
var order = function(field, dir){
    ...
    if(typeof field === "string"){
        ...
        if(dir!="desc"&&dir!="asc"){
            throw new Error("ORDER DIRECTION MUST BE desc or asc");
        }
...
var call = function(callback, fail){
    ...
    //AH! no callback
        ...
        throw new Error("YOU MUST DEFINE A SUCCESS FUNCTION BEFORE PERFORMING CALL");
    }
    ...
    //AH! no failure function. Lets fail! HA!
        ...
        throw new Error("YOU MUST DEFINE A FAILURE FUNCTION BEFORE PERFORMING CALL");
    }
...
var keyCheck = function(key){
    if(key==undefined){
        throw new Error("YOU MUST USE .init() TO DEFINE YOUR SUNLIGHT FOUNDATION API KEY!");
    }
}
...
module.exports.billsSearch  = function(slk){
    ...
    obj.queryBase = extend(true, {}, obj.query);
    obj.query = function(q){
